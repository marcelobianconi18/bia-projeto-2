...
export const PulseGraphWidget: React.FC<PulseGraphWidgetProps> = ({ dark = false }) => {
  ...
  return (
    <div className={`rounded-3xl flex flex-col h-full overflow-hidden transition-all shadow-xl ${dark ? 'bg-[#1c1f26] border border-white/5' : 'bg-[#f3f4f6] border border-slate-200'}`}>
      {/* Header */}
